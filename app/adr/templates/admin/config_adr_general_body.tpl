...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline" align="center">
	...
	<tr>
		<td class="row1" width="65%"><span class="gen">{L_PVP_DEFIES}</span><br /><span class="gensmall"><i>{L_PVP_DEFIES}</i></span></td>
...
<table border="0" cellpadding="4" cellspacing="1" width="100%" class="forumline" align="center">
	<tr>
		<th align="center" colspan="2">{L_USE_CACHE}</th>
	</tr>
	<tr>
		<td class="row1" width="65%">
			<span class="gen">{L_USE_CACHE}</span><br />
			<span class="gensmall"><i>{L_USE_CACHE_EXPLAIN}</i>
		</td>
		<td class="row1" align="center">&nbsp;</td>
	</tr>
	<tr>
		<td class="row2" width="65%"><li><i>adr/cache/cache_alignments.php = {CACHE_ALIGNMENTS_CHECK}</i></li></td>
		<td class="row2" align="center"><input type="checkbox" name="Adr_cache_alignment" value="1" {CACHE_ALIGNMENTS} /></td>
	</tr>
	<tr>
		<td class="row1" width="65%"><li><i>adr/cache/cache_classes.php = {CACHE_CLASSES_CHECK}</i></li></td>
		<td class="row1" align="center"><input type="checkbox" name="Adr_cache_class" value="1" {CACHE_CLASSES} /></td>
	</tr>
	<tr>
		<td class="row2" width="65%"><li><i>adr/cache/cache_config.php = {CACHE_CONFIG_CHECK}</i></li></td>
		<td class="row2" align="center"><input type="checkbox" name="Adr_cache_config" value="1" {CACHE_CONFIG} /></td>
	</tr>
	<tr>
		<td class="row1" width="65%"><li><i>adr/cache/cache_elements.php = {CACHE_ELEMENTS_CHECK}</i></li></td>
		<td class="row1" align="center"><input type="checkbox" name="Adr_cache_element" value="1" {CACHE_ELEMENTS} /></td>
	</tr>
	<tr>
		<td class="row2" width="65%"><li><i>adr/cache/cache_item_quality.php = {CACHE_ITEM_QUALITY_CHECK}</i></li></td>
		<td class="row2" align="center"><input type="checkbox" name="Adr_cache_item_quality" value="1" {CACHE_ITEM_QUALITY} /></td>
	</tr>
	<tr>
		<td class="row1" width="65%"><li><i>adr/cache/cache_item_type.php = {CACHE_ITEM_TYPE_CHECK}</i></li></td>
		<td class="row1" align="center"><input type="checkbox" name="Adr_cache_item_type" value="1" {CACHE_ITEM_TYPE} /></td>
	</tr>
	<tr>
		<td class="row2" width="65%"><li><i>adr/cache/cache_posters.php = {CACHE_POSTERS_CHECK}</i></li></td>
		<td class="row2" align="center"><input type="checkbox" name="Adr_cache_posters" value="1" {CACHE_POSTERS} /></td>
	</tr>
	<tr>
		<td class="row1" width="65%"><li><i>adr/cache/cache_races.php = {CACHE_RACES_CHECK}</i></li></td>
		<td class="row1" align="center"><input type="checkbox" name="Adr_cache_race" value="1" {CACHE_RACES} /></td>
	</tr>
	<tr>
		<td class="row2" width="65%"><li><i>adr/cache/cache_skills.php = {CACHE_SKILLS_CHECK}</i></li></td>
		<td class="row2" align="center"><input type="checkbox" name="Adr_cache_skill" value="1" {CACHE_SKILLS} /></td>
	</tr>
	<tr>
		<td class="row1" width="65%"><li><i>adr/cache/cache_monsters.php = {CACHE_MONSTERS_CHECK}</i></li></td>
		<td class="row1" align="center"><input type="checkbox" name="Adr_cache_monster" value="1" {CACHE_MONSTERS} /></td>
	</tr>
	<tr>
		<td class="row2" width="65%"><span class="gen">{L_CACHE_INT}:</span><br /><span class="gensmall"><i>{L_CACHE_INT_EX}</i></span></td>
		<td class="row2" align="center" ><input class="post" type="text" maxlength="4" size="4" name="Adr_cache_interval" value="{CACHE_INT}" /></td>
	</tr>
</table>
