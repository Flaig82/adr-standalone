...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline" width="100%">
	...
	<tr>
		<td class="{items.ROW_CLASS}" align="center" width="10%" rowspan="2"><br /><img src="../adr/images/items/{items.ITEM_IMG}" alt="{items.ITEM_NAME}"><br /><b>{items.ITEM_NAME}</b><br /><br />
			<a href="{items.U_ITEM_EDIT}">{L_EDIT}</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="{items.U_ITEM_COPY}">{L_COPY}</a><br></span></td>
	...
	<form method="post" action="{S_SHOPS_ACTION}">
	<tr>
		<td class="catBottom" colspan="7" align="center">{S_HIDDEN_FIELDS}<input type="submit" value="{L_ADD_ITEM}" class="mainoption" /></td>
	</tr>
</table>
