...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline" width="100%">
	<tr>
		...
		<td align="center" class="row1"><input type="post" name="name" size="30" maxlength="40" value="{NAME}" tabindex="1"></td>
	...
	<tr>
		...
		<td align="center" class="row1"><textarea name="bio" rows="5" cols="35" wrap="virtual" style="width:450px" tabindex="2" class="post" >{BIO}</textarea></td>
		...
		<td class="row1" width="50%" align="center"><span class="gen"><b>{L_CHARACTERISTICS}</b></span><br /><br />
			<table cellspacing="1" cellpadding="1" border="0" align="center"width="100%">
				...
				<tr>
					...
					<!-- BEGIN reroll -->
					<input type="submit" value="{L_REROLL}" class="liteoption" tabindex="3" />
					<!-- END reroll -->
					</td>
				</tr>
			</table>
			...
			<tr>
				...
				<td width="50%" align="center">
					<table>
						...
						<tr>
							<td width="100%" align="center" onMouseOver="this.style.backgroundColor='{T_TD_COLOR1}'; this.style.cursor='pointer';" onMouseOut=this.style.backgroundColor="{T_TR_COLOR2}" onClick="getraceid(document.charform.race);"><span class="gensmall" style="cursor: pointer;">{L_RACES_MINI_FAQ}</span></td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				...
				<td width="50%" align="center">
					<table>
						...
						<tr>
							<td width="100%" align="center" onMouseOver="this.style.backgroundColor='{T_TD_COLOR1}'; this.style.cursor='pointer';" onMouseOut=this.style.backgroundColor="{T_TR_COLOR2}" onClick="getelementid(document.charform.element);"><span class="gensmall" style="cursor: pointer;">{L_ELEMENTS_MINI_FAQ}</span></td>
						</tr>
					</table>
				</td>
			</tr>
			<tr>
				...
				<td width="50%" align="center">
					<table>
						...
						<tr>
							<td width="100%" align="center" onMouseOver="this.style.backgroundColor='{T_TD_COLOR1}'; this.style.cursor='pointer';" onMouseOut=this.style.backgroundColor="{T_TR_COLOR2}" onClick="getalignmentid(document.charform.alignment.SelectedIndex);"><span class="gensmall" style="cursor: pointer;">{L_ALIGNMENTS_MINI_FAQ}</span></td>
						</tr>
					</table>
				</td>
			</tr>
...
<table cellspacing="1" cellpadding="4" border="0" align="center" class="forumline" width="100%">
	<tr>
		...
		<input type="hidden" name="willpower" value="{WILLPOWER}" />
		<input type="hidden" name="charm" value="{CHARM}" />
		<td class="row3" align="center" >{HIDDEN_FIELDS}<input type="submit" value="{L_STEP2}" name="Step2" class="liteoption" tabindex="7" /></td>
	</tr>
</table>
<!-- END nocharacter -->
