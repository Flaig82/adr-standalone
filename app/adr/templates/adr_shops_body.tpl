...
<table cellspacing="2" cellpadding="2" border="1" align="center" class="forumline" width="50%" >
	<tr>
		<td align="center" class="row1" onMouseOver="this.style.backgroundColor='{T_TD_COLOR2}'; this.style.cursor='hand';" onMouseOut=this.style.backgroundColor="{T_TR_COLOR1}" onClick="window.location.href='{U_FORUM_SHOPS}';"><span class="gen">{L_FORUM_SHOPS}</span></td>
	</tr>
	<tr>
		<td align="center" class="row2" onMouseOver="this.style.backgroundColor='{T_TD_COLOR1}'; this.style.cursor='pointer';" onMouseOut=this.style.backgroundColor="{T_TR_COLOR2}" onClick="window.location.href='{U_LIST_SHOPS}';"><span class="gen">{L_LIST_SHOPS}</span></td>
	</tr>
	<tr>
		<td align="center" class="row1" onMouseOver="this.style.backgroundColor='{T_TD_COLOR2}'; this.style.cursor='pointer';" onMouseOut=this.style.backgroundColor="{T_TR_COLOR1}" onClick="window.location.href='{U_SEARCH_ITEM}';"><span class="gen">{L_SEARCH_ITEM}</span></td>
	</tr>
<!-- BEGIN no_shop -->
	<tr>
		<td align="center" class="row2" onMouseOver="this.style.backgroundColor='{T_TD_COLOR1}'; this.style.cursor='pointer';" onMouseOut=this.style.backgroundColor="{T_TR_COLOR2}" onClick="window.location.href='{U_CREATE_SHOP}';"><span class="gen">{L_CREATE_SHOP}</span></td>
	</tr>
<!-- END no_shop -->
<!-- BEGIN shop -->
	<tr>
		<td align="center" class="row2" onMouseOver="this.style.backgroundColor='{T_TD_COLOR1}'; this.style.cursor='pointer';" onMouseOut=this.style.backgroundColor="{T_TR_COLOR2}" onClick="window.location.href='{U_MANAGE_SHOP}';"><span class="gen">{L_MANAGE_SHOP}</span></td>
	</tr>
<!-- END shop -->
</table>
<br clear="all" />
...
<table cellspacing="2" cellpadding="2" border="1" align="center" class="forumline" width="50%" >
	<tr>
		<td align="center" class="row1" onMouseOver="this.style.backgroundColor='{T_TD_COLOR2}'; this.style.cursor='pointer';" onMouseOut=this.style.backgroundColor="{T_TR_COLOR1}" onClick="window.location.href='{U_SHOP_EDIT}';"><span class="gen">{L_SHOP_EDIT}</span></td>
	</tr>
	<tr>
		<td align="center" class="row2" onMouseOver="this.style.backgroundColor='{T_TD_COLOR1}'; this.style.cursor='pointer';" onMouseOut=this.style.backgroundColor="{T_TR_COLOR2}" onClick="window.location.href='{U_SHOP_DELETE}';"><span class="gen">{L_SHOP_DELETE}</span></td>
	</tr>
</table>
<!-- END owner -->
</form>
