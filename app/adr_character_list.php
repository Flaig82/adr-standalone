...
$sql = "SELECT c.* , s.shop_id , s.shop_name , u.username , u.user_id , u.user_avatar_type , u.user_allowavatar , u.user_avatar FROM " . ADR_CHARACTERS_TABLE . " c , " . USERS_TABLE . " u 
	LEFT JOIN " . ADR_SHOPS_TABLE . " s ON ( s.shop_owner_id = u.user_id )
	WHERE c.character_id = u.user_id
	AND u.user_id > 1
	ORDER BY $order_by";
